...
public class SlxToXmlTransformer {
	...
	public XmlRecord convert(SlxRecord r) throws InvalidMarkupException, IOException{
		...
		else if (tree.childrenCount() == 0) throw new InvalidMarkupException("Tree cannot be empty - record tag should exist");
	...
	public void splitGhosts(TNode b) throws InvalidMarkupException{
		...
		if (b.t == null && !b.isRoot) throw new InvalidMarkupException("Error converting SLX to XML: Token not attached to tree node.");
...
/*
		...
		*/
		...
		public void insertParent(List<TNode> affectedChildren, SlxToken t, boolean keepIfEmpty,int insertEmptyTagAt, SlxToXmlTransformer optionalCaller) throws InvalidMarkupException{
			...
			if (insertEmptyTagAt < 0 && keepIfEmpty) throw new InvalidMarkupException("Please specify a positive insertEmptyTagAt value if keepIfEmpty=true");
			...
			if (n.ghostPairs != null && ghostPairs != null){
				...
				if (n.ghostPairs != null && ghostPairs == null) n.ghostPairs = null; //If the parent has no ghost pairs, we shouldn't have any.
			}
	...
	private class TNodeStack extends Stack<TNode>{
	    ...
	    public void process(TNode tn) throws InvalidMarkupException{
	        ...
	        if (t.isClosing()){
	        	if (this.size() < 1) throw new InvalidMarkupException("Unexpected closing tag - no matching opening tags",t);
	            ...
	            if (!isMatch){
	                ...
	                if (matchExistsInContext) throw new InvalidMarkupException("Closing tag for " + opener.t.markup + " expected first.",t);
