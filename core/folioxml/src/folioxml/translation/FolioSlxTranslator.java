...
public class FolioSlxTranslator{
    ...
    public static SlxToken convertTag(FolioToken ft) throws InvalidMarkupException{
        ...
        if (ft.matches("GR") && ft.assertCount(1)) return new SlxToken("<record-attribute/>").set("groups",ft.get(0));
        if (ft.matches("LV") && ft.assertCount(1)) return new SlxToken("<record-attribute/>").set("level",ft.get(0)).set("class",ft.get(0)); //Aug 13 - think I fixed <LV> handling bug where class didn't get added.
   ...
   */
    ...
    if (ft.matches("CH")) {
            ...
            if (ft.isClosing()) t.tagType = SlxToken.TagType.Closing;
                ...
                while(index < opts.size()){
                    if ((t.get("title") == null) && !FolioCssUtils.isFolioUnit(ft.get(index) )){
                        if (!ft.wasQuoted(index)) {} //warning!!! Quotes are required on the title!!
                ...
                if (ft.matches("DP") && (t.get("title") == null)) throw new InvalidMarkupException("The title is required on named popups - they must be named. ");
                if (index < opts.size()){
      ...
      //Try Tables (TA, RO, CE)
        t = tryTables(ft); if (t != null) return t;
        ...
        t = tryDefinitionTags(ft); if (t != null)  return t;

        //comment out User Extension data
        t = tryCommentOut(ft,"UX"); if (t != null) return t;
    ...
    public static String getCharacterAttrType(String c){
        c = c.toLowerCase(); if (c.length() >= 2) c= c.substring(0,2);
    ...
    public static SlxToken tryDefinitionTags(FolioToken ft) throws InvalidMarkupException{
        ...
        if (t != null) {
            if (replaceMode != null) t.set("replaceDefinition", replaceMode); //TODO: is this handled properly in HTML/CSS conversion?
            return t;
        }
        if (replaceMode != null) throw new InvalidMarkupException("RP (Replace Definition) option found on a non-definition tag.");
        return null;
}
    public static SlxToken tryDefinitionTagsCore(FolioToken ft) throws InvalidMarkupException{
        ...
        */
        ...
        t = tryRename(ft,"HE","<infobase-meta type=\"header\">"); if (t != null) return t;
        t = tryRename(ft,"FO","<infobase-meta type=\"footer\">"); if (t != null) return t;
        
        
        t = tryRename(ft,"AU","<infobase-meta type=\"author\">"); if (t != null) return t;
        t = tryRename(ft,"AS","<infobase-meta type=\"abstract\">"); if (t != null) return t;
        t = tryRename(ft,"RM","<infobase-meta type=\"remark\">"); if (t != null) return t;
        t = tryRename(ft,"SU","<infobase-meta type=\"subject\">"); if (t != null) return t;
        ...
        t = tryRename(ft,"DQ","<infobase-meta type=\"default-query\">"); if (t != null) return t;
        
        //Generate codes for footer/header
        t = tryCommentOut(ft,"GP|GT|GD|GM|GI|GA|GF|GQ"); if (t != null) return t;
        ...
        if (ft.matches("FE|ST|LE|PD|PA")){
            ...
            if (stoppedBefore < opts.size()) throw new InvalidMarkupException("Failed to parse all options on " + ft.text + ". Remaining text: " + join(opts.subList(stoppedBefore, opts.size())));
        ...
        //LN level definition
        if (ft.matches("LN")) return new SlxToken("<infobase-meta type=\"levels\"/>").set("content", join(ft.getOptionsArray()));
    ...
    public static SlxToken tryTables(FolioToken ft) throws InvalidMarkupException{
    	...
    	if (ft.isClosing()){
    		if (ft.count() > 0) throw new InvalidMarkupException("Closing </TA> </RO>, and </CE> tags cannot have attributes.",ft);
    	...
    	if (ft.matches("RO")){
    		...
    		if (ft.count() > 1 || (ft.count() > 0 && !isHeader)) throw new InvalidMarkupException("RO tags can only have one attribute - HE (header row).",ft);
   ...
   // private static String rStr = "[A-Za-z0-9]|\"(?:[^\"]*(?:\"\")?)*\"";
    ...
    public static SlxToken tryCommentOut(FolioToken ft, String regex) throws InvalidMarkupException{
        ...
        if (ft.matches(regex)) return new SlxToken(SlxToken.TokenType.Comment,"<!--" + ft.text.replaceAll("--", "-&#x002D") + "-->"); //Added -- encoding, since that is a banned combination within XML comments.
        return null;
    }
