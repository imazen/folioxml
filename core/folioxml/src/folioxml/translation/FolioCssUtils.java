...
*/
    ...
    public static int tryParseTableAlign(int startIndex, List<String> opts, StringWriter css) {
        ...
        if (name.equalsIgnoreCase("JU")) {
            ...
            if (value.equalsIgnoreCase("LF"))
                css.append("margin-right:auto !important; -folio-align:left;"); //Conflicts with indents -- need to have smart CSS resolve this...
            else if (value.equalsIgnoreCase("CN"))
                css.append("margin-left:auto !important; margin-right:auto !important; -folio-align:center;");
