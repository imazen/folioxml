...
public class SlxContextStack{
     ...
     * @return
     */
    public boolean inXmlMode(){return inXmlMode;}
     ...
     * @return
     */
    public boolean taggingGhostPairs(){return tagGhostPairs;}
    ...
    public void add(SlxToken t) throws InvalidMarkupException{
    	if (t.isGhost && inXmlMode) throw new InvalidMarkupException("SlxContextStack prohibits ghost tags when in XML mode",t);
        stack.push(t); 
    }
    ...
    public boolean pullGhost(SlxToken t) throws InvalidMarkupException{
        ...
        if (index > -1) { stack.remove(index); return true;}
        return false;
    }
    /**
